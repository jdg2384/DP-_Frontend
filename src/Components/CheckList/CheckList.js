...
class CheckList extends Component {
    componentDidMount() {
        ...
        this.props.dpGetOne(this.props.history.location.pathname.match(/[0-9]/gi).join('')),
        this.props.pipeDriveGetOne(this.props.history.location.pathname.match(/[0-9]/gi).join(''))
        this.props.updatePipeDriveId(this.props.history.location.pathname.match(/[0-9]/gi).join(''))
    }
